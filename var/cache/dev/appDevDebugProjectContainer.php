...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.other' => 'getSecurity_Firewall_Map_Context_OtherService',
    ...
    {
        return $this->services['app.token_authenticator'] = new \AppBundle\Security\TokenAuthenticator($this->get('app.user_service'));
    }
    ...
    {
        return $this->services['app.user_service'] = new \AppBundle\Services\UserService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'onlinesenpai', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0470f2ae1a0986191e07cd952c2c6eb2bfc86ad30d15e08a94231b6efc1eb5cf');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.other' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, array(0 => 'POST', 1 => 'PUT'));

        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/users', NULL, array(0 => 'GET'));

        $h = new \Symfony\Component\Security\Http\AccessMap();
        $h->add($f, array(0 => 'ROLE_ADMIN'), NULL);
        $h->add($g, array(0 => 'ROLE_ADMIN'), NULL);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $b, 'main', array(0 => $c), $a), 2 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $this->get('security.access.decision_manager'), $h, $b)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($e, $e), 'main', $c, NULL, NULL, $a, true));
    }

    /**
     * Gets the 'security.firewall.map.context.other' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_OtherService()
    {
        return $this->services['security.firewall.map.context.other'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('887278ed24a0a9feac1de51cd7c382b87f09e820');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '887278ed24a0a9feac1de51cd7c382b87f09e820',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '887278ed24a0a9feac1de51cd7c382b87f09e820',
